	...
	try {
		...
		const exports = ((code) => {
			...
			while ((match = exportPattern.exec(code)) !== null) {
				...
				const exportVar = exportedName === variableName ? variableName : `${variableName} as ${exportedName}`
		...
		const transformed = [imports, lookup, require, `const exports = {}; const module = { exports };`, code, exports, `export default module.exports;`].join('\n\n')
