...
export const require_site_list = createStoreLoader<Pick<Site, 'id' | 'name' | 'description' | 'index'>[], [Id]>(
	(site_group_id) => Sites.getFullList({ filter: `group.id = "${site_group_id}"`, fields: 'id, name, description, index' }),
	[]
)
